...
#define CONFIG_PLATFORM_NAME "lattice_ice40up5k_evn"
...
static inline const char * config_identifier_read(void) {
	return "Minimal SERV SoC - VSD Mini";
}
