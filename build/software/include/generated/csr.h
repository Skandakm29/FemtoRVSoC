...
/* SERIAL Registers */
#define CSR_SERIAL_BASE (CSR_BASE + 0x1000L)
#define CSR_SERIAL_RXTX_ADDR (CSR_BASE + 0x1000L)
#define CSR_SERIAL_RXTX_SIZE 1
#define CSR_SERIAL_TXFULL_ADDR (CSR_BASE + 0x1004L)
#define CSR_SERIAL_TXFULL_SIZE 1
#define CSR_SERIAL_RXEMPTY_ADDR (CSR_BASE + 0x1008L)
#define CSR_SERIAL_RXEMPTY_SIZE 1
#define CSR_SERIAL_EV_STATUS_ADDR (CSR_BASE + 0x100cL)
#define CSR_SERIAL_EV_STATUS_SIZE 1
#define CSR_SERIAL_EV_PENDING_ADDR (CSR_BASE + 0x1010L)
#define CSR_SERIAL_EV_PENDING_SIZE 1
#define CSR_SERIAL_EV_ENABLE_ADDR (CSR_BASE + 0x1014L)
#define CSR_SERIAL_EV_ENABLE_SIZE 1
#define CSR_SERIAL_TXEMPTY_ADDR (CSR_BASE + 0x1018L)
#define CSR_SERIAL_TXEMPTY_SIZE 1
#define CSR_SERIAL_RXFULL_ADDR (CSR_BASE + 0x101cL)
